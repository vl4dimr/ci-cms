...
<form class="delete" action="<?=site_url('admin/freeback/delete/'.$mailto[0]['id'])?>" method="post">
	<p>
		<input type="button" name="noway" value="<?=__("No", $this->template['module'])?>" onclick="parent.location='<?=site_url('admin/freeback')?>'" class="input-submit" style="margin-right: 2em;" />
