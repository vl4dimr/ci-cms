...
<h1 id="edit"><?=__("Add new document")?></h1>
...
<form  enctype="multipart/form-data" class="edit" action="<?=site_url('admin/downloads/document/save')?>" method="post" accept-charset="utf-8">
		...
		<ul>
			...
			<li><a href="<?=site_url('admin/downloads/index/'.$cat)?>" class="input-submit last"><?=__("Cancel")?></a></li>
		</ul>
		...
		<label for="file_id"><?=__("Downloaded")?>:</label>
		...
		<label for="file_link"><?=__("or Link")?>:</label>
