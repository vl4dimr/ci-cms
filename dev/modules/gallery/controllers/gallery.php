...
class Gallery extends Controller {
	...
	function getAjaxNavH($show=true)
	{
		...
		foreach($images as $image)
		{
			...
			$out .= '<td class="galleryNavHTd"><a class="galleryNavHA" rel="'
	...
	function getAjaxMainImage($show=true)
	{
		...
		$out .= '<h3 class="galleryImageTitle">'.$image['name'].'</h3>';
		$out .= '<p class="galleryImageCaption">'.substr($image['caption'], 0, 150).'<br />';
		$out .= 'Taken By: '.$image['author'].'<br /></p>';
