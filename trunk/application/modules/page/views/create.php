...
<form  enctype="multipart/form-data" class="edit" action="<?php echo site_url('admin/page/create')?>" method="post" accept-charset="utf-8">
		...
		<option value="<?php echo $parent['id']?>" <?php echo (($parent['id'] == $parent_id)? " selected ": "") ?> ><?php echo ($parent['level'] > 0) ? "|".str_repeat("__", $parent['level']): ""?> <?php echo (strlen($parent['title']) > 50 )? substr($parent['title'], 0, 50) . '...': $parent['title'] ?> </option>
