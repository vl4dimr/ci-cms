...
<head>
	...
	<link rel="shortcut icon" href="<?=base_url()?>application/views/blaze/site/images/favicon.ico" type="image/x-icon" />
	<link rel="stylesheet" href="<?=base_url()?>application/views/blaze/site/style/stylesheet.css" type="text/css" media="screen" charset="utf-8" />
	<!--[if IE]>
		<link rel="stylesheet" href="<?=base_url()?>application/views/blaze/site/style/iefix.css" type="text/css" media="screen" charset="utf-8" />
	<![endif]-->
	<script src="<?=base_url()?>application/views/blaze/site/javascript/jquery.js" type="text/javascript"></script>
	<script src="<?=base_url()?>application/views/blaze/site/javascript/sitelib.js" type="text/javascript"></script>
	<script src="<?=base_url()?>application/views/blaze/site/javascript/external.js" type="text/javascript"></script>
</head>
...
<div id="header">
	<a class="logo" href="<?=base_url()?>application/views/" title="<?=$this->system->site_name?>">
		<img src="<?=base_url()?>application/views/blaze/site/images/blaze.png" alt="<?=$this->system->site_name?>" />
